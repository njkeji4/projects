			...
			<el-table :data="devices" resizable border highlight-current-row stripe v-loading="listLoading" ref="table" 
			 ...
			 @sort-change="handleSortChange"
			  class="cmcc-cell-nowrap">
				...
				<el-table-column  sortable="custom" prop="avol" label="1相电压" width="150"></el-table-column>
				<el-table-column  sortable="custom" prop="bvol" label="2相电压" width="150"></el-table-column>
				<el-table-column  sortable="custom" prop="cvol" label="3相电压" width="150"></el-table-column>
				
				
				<el-table-column  sortable="custom" prop="acur" label="1相电流" width="150"></el-table-column>
				<el-table-column  sortable="custom" prop="bcur" label="2相电流" width="150"></el-table-column>
				<el-table-column  sortable="custom" prop="ccur" label="3相电流" width="150"></el-table-column>
